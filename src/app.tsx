...
export async function getInitialState(): Promise<{
  ...
  if (history.location.pathname !== '/user/login') {
    const currentUser = await fetchUserInfo(); if (history.location.pathname === '/b') {
...
export const layout = ({
  ...
  initialState: { settings?: LayoutSettings; currentUser?: API.CurrentUser; clientSideMenuFlag?: boolean | undefined; };
}): BasicLayoutProps & {
